/**
 * PSD Template Import Plugin - Import Adobe Photoshop Files for CE.SDK
 *
 * This plugin provides a production-ready advanced editor configuration with
 * Photoshop file import capabilities, allowing users to import and edit
 * Adobe Photoshop templates (PSD) with professional editing features.
 *
 * @example Basic usage
 * ```typescript
 * import CreativeEditorSDK from '@cesdk/cesdk-js';
 * import { PsdTemplateImportConfig } from './plugin';
 *
...
/**
 * PSD Template Import configuration plugin.
 *
 * Provides Adobe Photoshop file import capabilities with a complete
 * professional editing experience optimized for power users.
 *
 * @public
 */
export class PsdTemplateImportConfig implements EditorPlugin {
  /**
   * Unique identifier for this plugin.
   * Used to identify the plugin in the CE.SDK plugin registry.
   */
  name = 'cesdk-psd-template-import';
